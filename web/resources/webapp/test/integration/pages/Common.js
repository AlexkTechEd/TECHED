sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("test/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("test.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["test/localService/mockserver"], function (mockserver) {
